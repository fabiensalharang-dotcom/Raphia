export const pilotage = {
  ...
  'pilotage.markAcquired': 'Marquer comme acquise',
  'pilotage.keepGoing': 'Garder encore un peu',
  ...
  'pilotage.rewriteCancel': 'Annuler',

  'pilotage.rewardFatigueBody': 'Les récompenses perdent en effet quand elles deviennent une habitude.',
  'pilotage.rewardFatigueIntroKnown': 'est choisie presque à chaque fois.',
  'pilotage.rewardFatigueIntroUnknown': "Le menu de récompenses n'a pas changé depuis un moment.",
  'pilotage.addRewards': 'Ajouter 2 récompenses au menu',
  'pilotage.allGood': 'Tout va bien',
